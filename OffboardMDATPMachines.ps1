...
$json = @{'Comment' = 'Offboard'} | ConvertTo-Json

foreach($machine in $machineList)
{
    $machine    
    $answer = Invoke-RestMethod -Headers $header -Uri  https://api-us.securitycenter.windows.com/api/machines/$machine/offboard -Method POST -Body $json -ContentType $contentType
}
